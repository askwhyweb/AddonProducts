...
namespace OrviSoft\AddonProducts\Model\Product\Attribute\Source;

class AddonAccessories extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    ...
    public function getAllAccessories(){
        ...
        foreach($data->getData() as $k => $v){
            $output[] = ['value' => $v['id'], 'label' => __($v['label'])];
        }
        return $output;
    }
}
