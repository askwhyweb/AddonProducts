...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('accessories');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('OrviSoft\AddonProducts\Model\Accessories')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('addonproducts/*/index');
    }
